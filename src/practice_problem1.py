...
class Box(object):
    ...
    def append_string(self, additional_contents):
        ...
        numberappend = min(space, len(additional_contents))
        add = ''
        for k in range(numberappend):
            add = add + additional_contents[k]
        self.contents = self.contents + add
        stuff_to_return = ''
        for k in range(numberappend, len(additional_contents)):
    ...
    def reset(self):
        ...
        #    TIME ESTIMATE:   5 minutes.
        # ---------------------------------------------------------------------
        self.original = self.original + [self.contents]
    ...
    def combined_box(self, other_box):
        ...
        #    TIME ESTIMATE:   5 minutes.
        # ---------------------------------------------------------------------
        anotherbox = Box(self.contents + other_box.contents, self.volume + other_box.volume)
        return anotherbox
###############################################################################
